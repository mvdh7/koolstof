...
def pH_optode(spreadsheet, text_files_folder_path):
    ...
    db = pd.read_excel(spreadsheet,
                       skiprows=[1])
    
    # Create list of text files
    file_list = [file for file in os.listdir(text_files_folder_path) if 
                  '_'.join(file.split('_')) in db.filename.values]
    ...
    for file in file_list:
        ...
        results.loc[results.filename==file,
                    'temperature'] = data[file].temp[lowest_ix]
